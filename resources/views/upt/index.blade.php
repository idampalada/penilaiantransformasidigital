...
<form id="upt-form"
    ...
    <div class="table-responsive-upt">
<table class="table table-bordered upt-table" style="border-collapse: separate !important;">
...
@endphp
                        ...
                        <tr class="upt-row" data-kategori="{{ strtoupper($item->kategori) }}">
