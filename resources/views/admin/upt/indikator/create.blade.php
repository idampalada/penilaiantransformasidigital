...
<div class="row">
    <div class="col-md-12">
        ...
        <h4><strong>Tambah Indikator UPT</strong></h4>
        <p class="text-muted">
            Admin menentukan struktur indikator (split / tidak split).
            UPT hanya mengisi file & nilai.
        </p>

        <form method="POST" action="{{ route('admin.upt.indikator.store') }}">
            @csrf
    ...
    <small class="text-muted">
        Digunakan untuk pengelompokan indikator (Organisasi / Proses / Data / Teknologi / Aplikasi / Keamanan)
            ...
            <div class="alert alert-info">
                ...
                <ul class="mb-0">
                    <li>Jumlah baris di landing UPT</li>
            ...
            <a href="{{ route('admin.upt.indikator.index') }}" class="btn btn-secondary">
                Kembali
            </a>
