document.addEventListener("DOMContentLoaded", function () {
    ...
    */
    ...
    if (filter) {
        filter.addEventListener("change", function () {
            ...
            var headers = document.querySelectorAll(".upt-group-header");
            var rows = document.querySelectorAll(".upt-row");
    ...
    */
    window.deleteFile = function (id) {
        if (confirm("Hapus file ini?")) {
            ...
            form.action = "/upt/bukti/" + id; // ✅ sudah benar
            form.submit();
        }
    };
    ...
    */
    ...
    const form = document.getElementById("upt-form");
    if (!form) return;
...
document.addEventListener("DOMContentLoaded", function () {
    const wrapper = document.querySelector(".table-responsive-upt");
    if (!wrapper) return;
